...
typedef NS_ENUM(NSInteger, UserPrivType)
{
    kUserPrivOperations = 1,
    kUserPrivAnchor,
    kUserPrivOrdinary,
    kUserPrivCustomerService,
    kUserPrivBroker,
    kUserPrivMax
};
...
@interface TTShowUserStar : NSObject <NSCoding>
...
@interface Finance : JSONModel

@property (nonatomic, assign) long long int bean_count;
@property (nonatomic, assign) long long int bean_count_total;
@property (nonatomic, assign) long long int coin_count;
@property (nonatomic, assign) long long int coin_spend_total;
@property (nonatomic, assign) long long int spend_star_level;
...
@interface TTShowUser : NSObject <NSCoding>
