...
@property (nonatomic, weak) id<PSTCollectionViewDelegate> collectionViewDelegate;
...
- (void)endItemAnimations {
    ...
    for (PSTCollectionViewUpdateItem *deleteItem in sortedDeletedMutableItems) {
        if ([deleteItem isSectionOperation]) {
            ...
            for (__unused PSTCollectionViewUpdateItem *moveItem in sortedMutableMoveItems) {
