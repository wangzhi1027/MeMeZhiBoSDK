...
#import "MMSDWebImagePrefetcher.h"

#if (!defined(DEBUG) && !defined (SD_VERBOSE)) || defined(SD_LOG_NONE)
#define NSLog(...)
#endif

@interface MMSDWebImagePrefetcher ()

@property (strong, nonatomic) MMSDWebImageManager *manager;
@property (strong, nonatomic) NSArray *prefetchURLs;
@property (assign, nonatomic) NSUInteger requestedCount;
@property (assign, nonatomic) NSUInteger skippedCount;
@property (assign, nonatomic) NSUInteger finishedCount;
@property (assign, nonatomic) NSTimeInterval startedTime;
@property (copy, nonatomic) MMSDWebImagePrefetcherCompletionBlock completionBlock;
@property (copy, nonatomic) MMSDWebImagePrefetcherProgressBlock progressBlock;

@end

@implementation MMSDWebImagePrefetcher
...
- (id)init {
    if ((self = [super init])) {
        _manager = [MMSDWebImageManager new];
