...
#import "UIButton+MMWebCache.h"
#import "objc/runtime.h"
#import "UIView+MMWebCacheOperation.h"

static char imageURLStorageKey;

@implementation UIButton (MMWebCache)
...
- (void)sd_setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(MMSDWebImageCompletionBlock)completedBlock {
    ...
    id <SDWebImageOperation> operation = [MMSDWebImageManager.sharedManager downloadImageWithURL:url options:options progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
        if (!wself) return;
...
@implementation UIButton (MMWebCacheDeprecated)
...
- (void)setImageWithURL:(NSURL *)url forState:(UIControlState)state completed:(MMSDWebImageCompletedBlock)completedBlock {
...
- (void)setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder completed:(MMSDWebImageCompletedBlock)completedBlock {
...
- (void)setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(MMSDWebImageCompletedBlock)completedBlock {
...
- (void)setBackgroundImageWithURL:(NSURL *)url forState:(UIControlState)state completed:(MMSDWebImageCompletedBlock)completedBlock {
...
- (void)setBackgroundImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder completed:(MMSDWebImageCompletedBlock)completedBlock {
...
- (void)setBackgroundImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(MMSDWebImageCompletedBlock)completedBlock {
