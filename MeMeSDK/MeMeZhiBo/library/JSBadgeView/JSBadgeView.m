...
#define kDefaultBadgeBackgroundColor kRGB(218.0f, 80.0f, 58.0f)//[UIColor redColor]
#define kDefaultOverlayColor kClearColor//[UIColor colorWithWhite:1.0f alpha:0.3]
...
#define kShadowColor [UIColor colorWithWhite:0.6f alpha:kShadowOpacity]
...
//            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f);
//            newFrame.origin.y = superviewHeight - (viewHeight / 2.0f);
            newFrame.origin.x = superviewWidth - (viewWidth * 3 / 4);
            newFrame.origin.y = superviewHeight - (viewHeight * 90 / 100);
            break;
