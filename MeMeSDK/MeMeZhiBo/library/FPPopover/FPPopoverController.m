...
- (void)setTitleTextColor:(UIColor *)titleTextColor
{
    ...
    [_contentView setTitleTextColor:titleTextColor];
    [_contentView setNeedsDisplay];
}
...
- (void)setTitleHidden:(BOOL)titleHidden
{
    ...
    [_contentView setTitleHidden:titleHidden];
    [_contentView setNeedsDisplay];
}
...
{
    CGPoint point = [self originFromView:_fromView];
    NSLog(@"presentPopoverFromView %f, %f", point.x, point.y);
