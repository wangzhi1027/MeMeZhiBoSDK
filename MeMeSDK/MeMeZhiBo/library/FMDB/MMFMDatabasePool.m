...
@interface MMFMDatabasePool()

- (void)pushDatabaseBackInPool:(MMFMDatabase*)db;
- (MMFMDatabase*)db;

@end


@implementation MMFMDatabasePool
...
- (MMFMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [MMFMDatabase databaseWithPath:_path];
        }
