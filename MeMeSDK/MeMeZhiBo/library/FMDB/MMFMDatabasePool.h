...
@interface MMFMDatabasePool : NSObject {
    NSString            *_path;
...
@interface NSObject (MMFMDatabasePoolDelegate)

- (BOOL)databasePool:(MMFMDatabasePool*)pool shouldAddDatabaseToPool:(MMFMDatabase*)database;
