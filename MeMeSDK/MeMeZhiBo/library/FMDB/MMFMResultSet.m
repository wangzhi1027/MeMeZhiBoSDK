...
@implementation MMFMResultSet
@synthesize query=_query;
@synthesize statement=_statement;

+ (id)resultSetWithStatement:(MMFMStatement *)statement usingParentDatabase:(MMFMDatabase*)aDB {
    
    MMFMResultSet *rs = [[MMFMResultSet alloc] init];
...
- (void)setParentDB:(MMFMDatabase *)newDb {
    _parentDB = newDb;
}
