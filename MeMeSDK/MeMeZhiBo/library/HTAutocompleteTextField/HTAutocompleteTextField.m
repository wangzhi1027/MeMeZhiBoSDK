...
//{
//    return CGRectMake(bounds.origin.x - 60.0f , bounds.origin.y - 3.0f, bounds.size.width, bounds.size.height);
//}
...
//    [self.autocompleteLabel setFrame: [self autocompleteRectForBounds:CGRectMake(10.0f, 10.0f, self.frame.size.width - 20.0f, self.frame.size.height - 20.0f)]];
