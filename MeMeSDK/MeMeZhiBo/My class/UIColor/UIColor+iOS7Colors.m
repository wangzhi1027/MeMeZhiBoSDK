...
+ (NSInteger)valueOfColor:(UIColor *)color
{
    if (CGColorGetNumberOfComponents([color CGColor]) > 3) {
        NSInteger r = (NSInteger)((CGColorGetComponents([color CGColor])[0] * 255)) << 16;
        NSInteger g = (NSInteger)((CGColorGetComponents([color CGColor])[1] * 255)) << 8;
        NSInteger b = ((NSInteger)CGColorGetComponents([color CGColor])[2] * 255);
        return r + g + b;
    }
    return 0xffffff;
}
...
{
    return [UIColor colorWithRGBValue:[UIColor randomRGBValue]];
}
